...
US_CONFIG = {
  ...
  UNIDENTIFIED_DROP_CHANCE = 99, -- 1:X chance that item in monster corpse will be unidentified, X means that approximately every X item will be unidentified
  ...
  RARITY = {
    [COMMON] = {
      ...
      chance = 3 -- 1:X chance that item will be common (1 = 100%)
    },
    [RARE] = {
      name = "rare",
      maxBonus = 2, -- max amount of bonus attributes
      chance = 43 -- 1:X chance that item will be common (1 = 100%)
    },
    [EPIC] = {
      name = "epic",
      maxBonus = 3, -- max amount of bonus attributes
      chance = 82 -- 1:X chance that item will be common (1 = 100%)
    },
    [LEGENDARY] = {
      name = "legendary",
